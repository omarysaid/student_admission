...
if (isset($_POST["update"])) {
    ...
    // Sanitize inputs
    $status_1 = mysqli_real_escape_string($connect, $status_1);

    // Prepare SQL query to update status_1 in students_info table
    $update_query = "UPDATE students_info SET status_1 = '$status_1' WHERE user_id = $user_id";
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <select name="status_1" class="form-control" style="height:50px">
